...
* This file is then put through the following steps
  ...
  are created
  - using the one-hot encoded values a correlation matrix is calculated, and the visualizations from that have also been uploaded. Note: these visuals are to be recreated in Power BI/Tableau for the final presentation.
